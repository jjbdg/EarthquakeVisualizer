      ...
      if(event.buttons > 0)
        {
            ...
            // this.earth.mouseRotation.multiply(this.earth.naturalRotation);
            this.earth.mouseRotation.multiply(Quaternion.makeRotationY(event.movementX * 0.01));
            this.earth.rotation.slerp(Quaternion.IDENTITY, this.earth.mouseRotation, this.earth.earthMaterial.morphAlpha);
        }
    }
